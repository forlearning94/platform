...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?= Url::toRoute(['site/index']) ?>" class="logo">
      ...
      <span class="logo-mini"><img src="<?=Yii::getAlias('@web') . '/dist/img/logo.png'?>" alt="logo"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="<?=Yii::getAlias('@web') . '/dist/img/logo.png'?>" alt="logo"></span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-brand hidden-xs" style="text-align:center;letter-spacing: 2px;font-weight: bold;color: #ebeffe;font-size: 1.5em;width: 80%;">
        ...
        <ul class="nav navbar-nav">
          ...
          <!-- Control Sidebar Toggle Button 
            <li class="user user-menu">
                <a href="#"><b><i class="fa fa-sign-in"> KIRISH </i></b></a>
            </li>
          -->
